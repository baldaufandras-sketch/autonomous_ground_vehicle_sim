...
Vehicle::Vehicle(const VehicleState& initial_state) : state_(initial_state),
        input_{0.0, 0.0}
{
}
...
{
    state_.speed =+ dt * input_.acceleration;
